	...
	<div class="modal fade" id="myModalEdit<?=$this->session->userdata('id_user')?>">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="<?php echo site_url('pencari/editpemilik'); ?>" method="post">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="no_hp" value="<?=$this->session->userdata('no_hp')?>"  required>
					</div>
					<div class="form-group">
						<label>Gender</label>
					...
					<div class="form-group">
						<label>Alamat</label>
						<textarea class="form-control" name="alamat"  required><?=$this->session->userdata('alamat')?></textarea>
					</div>
					<div class="form-group">
	...
	<div class="modal fade" id="myModalEditPassword<?=$this->session->userdata('id_user')?>">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="<?php echo site_url('pencari/editpassword'); ?>" method="post">
				<div class="modal-body">
					<div class="form-group">
